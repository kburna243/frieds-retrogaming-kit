...
export const SOURCES: KBSource[] = [
  { id: "SRC-KIT-001", title: "frieds-retrogaming-kit — project plan and README", url: REPO_URL, url_status: "unverified", authority: "official", confidence: "medium", legal: "ok", evergreen: false, summary: "Plan of frieds-retrogaming-kit: guided pinball and lightgun installers on a shared core, plus retro skills. Work in progress.", tags: ["kit", "installer", "pinball", "lightgun", "skills"] },
